...
**Last reviewed:** 2026-09-20 · **As of:** v2.15.1""
...
The action installs the exact `package-version` input (default: `2.15.1`). Its
...
last published package (`2.15.1`), which keeps pull-request validation
